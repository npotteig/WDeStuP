...
The PetriNetVerify-class is imported from both run_plugin.py and run_debug.py
"""
import sys
import logging
...
class PetriNetVerify(PluginBase):
    def main(self):
        ...
        for arc in arcs.keys():
            myArc = arcs[arc]
            if core.is_instance_of(myArc, META['InArc']):
            ...
            elif core.is_instance_of(myArc, META['OutArc']):

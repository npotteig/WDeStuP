"""
This script is called by the plugin-wrapper, PetriNetVerify.js, which passes down the
...
from PetriNetVerify import PetriNetVerify

logger = logging.getLogger('PetriNetVerify')
...
plugin = PetriNetVerify(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
